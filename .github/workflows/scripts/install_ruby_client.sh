...
then
  curl --fail-with-body -k -o api.json "${PULP_URL}${PULP_API_ROOT}api/v3/docs/api.json?bindings&component=file"
  USE_LOCAL_API_JSON=1 ./generate.sh pulp_file ruby "$VERSION"
else
...
tar cvf ../../pulp_file/file-ruby-client.tar "./pulp_file_client-$VERSION.gem"
popd
popd
