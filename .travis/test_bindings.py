        ...
        while True:
            ...
            with NamedTemporaryFile() as file_chunk:
                ...
                upload = uploads.update(
                    upload_href=upload.href, file=file_chunk.name, content_range=content_range
                )
            offset += chunk_size
...
filecontent = filecontent.create(relative_path="foo.tar.gz", artifact=artifact.href)
pprint(filecontent)
